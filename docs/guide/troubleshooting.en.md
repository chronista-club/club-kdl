...
If you need a custom conversion, see the [Custom Types Guide](./custom-types.en.md).
...
**Fix**: Wrap in a newtype. See the [Custom Types Guide](./custom-types.en.md) for details.
...
- [Custom Types Guide](./custom-types.en.md)
- [KDL Design Best Practices](./best-practices.en.md)
