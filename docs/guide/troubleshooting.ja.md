...
カスタム変換が必要なら [カスタム型ガイド](./custom-types.ja.md) を参照。
...
**対処**: newtype でラップする。 詳細は [カスタム型ガイド](./custom-types.ja.md) を参照。
...
- [カスタム型ガイド](./custom-types.ja.md)
- [KDL 設計ベストプラクティス](./best-practices.ja.md)
