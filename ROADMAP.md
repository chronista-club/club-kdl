...
### Phase 1 — Schema Codegen foundation (`club-kdl-codegen`) — ✅ **完了 (v0.7.0、 2026-05-17)**
...
**成果**: `club-kdl-codegen` crate を新設 (v0.6.0) → 4 ターゲット完成 (v0.7.0)。
IR (data / protocol 2 方言) + parser + Rust / TypeScript / Zod / SurrealQL emitter + CLI。
codegen test 51 (41 unit + 10 integration)。 設計方針との照合・整備は memory
`mem_1Cb7UfM1F8Gfa3ZRvuZY55` / `mem_1Cb7bVNQ7n5f47LVZUd5A4` 参照。
残 = club-unison を `club-kdl-codegen` ベースに載せ替え (REQ-009) ―― 別 repo・Phase 2 寄り。
